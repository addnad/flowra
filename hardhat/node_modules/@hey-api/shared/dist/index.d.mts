...
import { CodeSampleObject, JSONSchemaDraft2020_12, OpenAPIExtensions, OpenAPIV2, OpenAPIV3, OpenAPIV3_1 } from "@hey-api/spec-types";
...
interface IROperationObject extends OpenAPIExtensions {
  body?: IRBodyObject;
  deprecated?: boolean;
  description?: string;
  id: string;
...
interface IRParameterObject extends Pick<JSONSchemaDraft2020_12.Document, 'deprecated' | 'description'>, OpenAPIExtensions {
  /**
...
interface IRSchemaObject extends Pick<JSONSchemaDraft2020_12.Document, '$ref' | 'const' | 'default' | 'deprecated' | 'description' | 'exclusiveMaximum' | 'exclusiveMinimum' | 'maximum' | 'maxItems' | 'maxLength' | 'minimum' | 'minItems' | 'minLength' | 'pattern' | 'required' | 'title' | 'example'>, OpenAPIExtensions {
  /**
